...
namespace PdfChords
{
    class Defines
    {
        public const string CHORDII_FILE_EXTENSION = ".xml";
        public const string PRO_FILE_EXTENSION = ".pro";
        ...
        public const int EDITOR_MIN_WIDTH = 500;
        public const int BROWSER_MIN_WIDTH = 250;
    }
}
